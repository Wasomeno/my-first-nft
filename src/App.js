...
function App() {
  ...
  return (
    <HelmetProvider>
      <div id="app" className="App container-fluid vh-100">
        <Helmet>
        ...
        <BrowserRouter>
          <Routes>
            ...
            >
              <Route
                index
                element={<MainPage account={account} setAccount={setAccount} />}
              />
              <Route
                path="inventory/*"
                element={
              ...
              <Route
                path="staking"
                element={
                  <BeanzStaking account={account} setAccount={setAccount} />
                }
              />
              <Route
                path="marketplace/*"
                element={
                  <Marketplace account={account} setAccount={setAccount} />
                }
              />
            </Route>
          </Routes>
