...
const MainPage = ({account, setAccount}) => {
    ...
    return(
        <div id="mainpage" className="vh-100 d-flex flex-column justify-content-center align-items-center">
                <div className="p-2">
                ...
                <div className="p-2 m-3">
                    <div id="mint-container" className="d-flex justify-content-between">
                        <button id="decrement-button" onClick={decrement} className="btn m-1">-</button>
                        <input type="text" className="form-control m-1" value={mintAmount}/>
                        <button id="increment-button" onClick={increment} className="btn m-1">+</button>
                    </div>
                    <button id="mint-button" onClick={beanzMint} className="mt-3"> Mint</button>
                </div>
                ) : (
                    <div>
