...
const MarketplaceList = ({ account }) => {
  ...
  return (
    <div className="h-75">
      <h1 id="marketplace-title" className="m-3 p-1">
        CoolBeanz Marketplace
      </h1>
            ...
            {beanzs[0] ? (
              beanzs.map((beanz, index) => (
                <div
                  id="marketplace-card"
                  key={index}
                  className="card col-2 m-2 border-1 border-dark"
                  onClick={() => navigate(beanz.data.name.slice(6, 7))}
                >
                  <img
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex justify-content-center align-items-center">
                      <img
                        ...
                        className="p-1"
                      />
                      <p id="marketplace-card-text" className="p-1 m-0">
                        {beanz.beanzPrice[0].toString() / 10 ** 18}
                      </p>
                    </div>
                  </div>
                </div>
